...
library(tidyverse) # used for data transformation
library(caret) # used for ML
library(mlbench) # ML datasets library

# load the dataset, there're datasets in package mlbench
data() # call the list of datasets
